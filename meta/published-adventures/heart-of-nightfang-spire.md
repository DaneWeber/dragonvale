...
The Dragonvale campaign began with the Sunless Citadel and followed the first adventures of the series.
...
After the Standing Stone, the players were too low of a level for the Heart of Nightfang Spire, so I included several hooks and the players essentially completed the _Against the Giants_ old adventure, using the original material but the updated 3e maps provided by WotC.

My current hypothesized path forward is to tackle the _Heart of Nightfang Spire_, head into the Underdark to deal with the Drow in Erelhei-Cinlu, and cap with the _Bastion of Broken Souls_. I've also included an option for _The Great Modron March_, if they're curious.

While reading various reviews and commentary, there's a bit about Nightfang Spire that I was tempted to change dramatically, although I believe I'm back to running it almost as written, but with the following changes in order to make me happy about internal consistency.

## Changes to the Overall Adventure

### Gulthias Motivation and Scheme

The books seems to indicate that Gulthias just wants to create a horde of undead and rule the nearby lands.

Reacting to the conclusion of https://thealexandrian.net/wordpress/52666/roleplaying-games/ex-rpgnet-review-heart-of-nightfang-spire I want more of a scheme.

Gulthias has Ashardalon's necromantic heart and his experimentation with flesh is intended to create a new body for Ashardalon so that he can return to the world.

In my cosmology (closely aligned with published 3e/3.5e material), I've elaborated the plane of shadow as shaped by thought, emotion, and memory. In this world, "losing your shadow" is about losing your memory and identity. When dying and crossing the river Styx, the soul is stripped of its shadow. The shadow plane is also the home of your mirror self, which is one form of your shadow.

Vampires have lost their soul, but are animated by negative energy and their shadow. This is why they cast no shadow and have no reflection.

A shadow of Ashardalon exists in the shadow plane around Nightfang Spire.

Gulthias' plan is to create a body for Ashardalon using the heart and binding Ashardalon's shadow to it.

### Gulthias Tree Connection to Ravenloft

As per https://scholarsandserpents.wordpress.com/2018/02/21/ashardalon-and-the-vampire-gulthias/ I like the idea that Gulthias traveled to a domain of dread, via the shadow, in order to learn the secrets required to bring Ashardalon back to life/unlife. That informs some of my changes. To this end, I am adding a (psionic) mind flayer who was the source of the information on how to travel to the Domains of Dread.
...
The elf is instead a human. Elves are immune to sleep.

While the ossuary is not detailed, 1000 years ago it was used by the cult and included room dividers and curtains. There is a tiled area raised above the floor that is 10 x 10 feet. This location teleports into the altar room (#71), but is controlled from that room. It cannot be triggered from the Ossuary except by holding one part of the Dragon Key.
...
Thiff follows magic and has stained fur, along with the alpha male who also follows magic.

The Alpha Male is a Quaggoth War Leader. Thiff is a Greater Quaggoth with three additional levels of Expert, skill points applied to skills that make her the brains of the operation.

There is a gate that does not appear on the map. It cuts off access to the Underdark when locked. The Quaggoths broke in, but preserved the gate, which serves as valuable protection from other Underdark denizens.

### 56. Sprung Trap, Empty Vault

In addition, there is a basin fed by a rainwater cistern. Very little rain falls, especially now that Gulthias has returned, but this water source was additional motivation for the Quaggoths to move in.
...
Cultists made it to this room not by getting a tour of the tower or via the Underdark (generally), but by gathering within the one stone building outside of the tower and standing in a specific location. A button hidden (Search DC 15) on the side of the altar swaps what is in the Ossuary on the 10x10 location with the 10x10 location at the far end of the altar room.

The literal "death trap" is funny in concept, but it doesn't make sense to me for the altar. I'm thinking of doing the following:
...
Stats are from _The Drow of the Underdark_, pages 136-139. I plan to remove the magic items in favor of the published adventure, although that may require a little math.
...
Quaggoth (Raging):
  CR: 3
  Type: Usually NE Medium monstrous humanoid
  Init: +4
...
Greater Quaggoth (Raging):
  CR: 6
  Type: Male quaggoth barbarian 3 NE Medium monstrous humanoid
  Init: +4
  ...
  Melee: +1 greatclub +17/+12 (1d10+14) and bite +11 (1d6+4)
  Space: 5 ft.
  Reach: 5 ft.
  Base Atk: +7
  Grp: +16
  ...
  SQ: trap sense +1
  Feats: Cleave, Diehard*, Improved Initiative, Power Attack
  Skills: Climb +19, Jump +17, Listen +7, Spot +6
  Possessions: combat gear plus +1 greatclub, bracers of armor +2, gauntlets of ogre power
```

Light Sensitivity (Ex) A greater quaggoth is dazzled in bright sunlight or within the radius of a daylight spell.

Rage (Ex) Once per day, a greater quaggoth can fly into a screaming blood frenzy. This ability functions like a barbarian’s rage (PH 25), except that the quaggoth suffers no ill effects after the rage ends.

When not raging, a greater quaggoth has the following changed statistics:

```yaml
AC: 17, touch 10, flat-footed 17
hp: 72 (7 HD)
Saves: Fort +8, Will +7
Melee: +1 greatclub +15/+10 (1d10+11) and bite +9 (1d6+3)
Grp: +14
Abilities: Str 24, Con 19
Skills: Climb +17, Hide +3 (+7 in shadow), Jump +17, Search +2, Survival +10
```
...
Quaggoth War Leader (Raging):
  CR: 10
  Type: Male quaggoth barbarian 7 NE Medium monstrous humanoid
  Init: +4
  Senses: darkvision 120 ft., scent; Listen +9, Spot +5
  Languages: Undercommon
  ...
  SQ: trap sense +2
  Feats: Cleave, DiehardB, Great Cleave, Improved Initiative, Power Attack
  Skills: Climb +17, Intimidate +9, Jump +19, Listen +9, Spot +5
  Possessions: combat gear plus +3 hide armor, +1 keen elf bane greataxe, amulet of natural armor +1, gauntlets of ogre power
```

Light Sensitivity (Ex) A quaggoth war leader is dazzled in bright sunlight or within the radius of a daylight spell.

Rage (Ex) Once per day, a quaggoth war leader can fly into a screaming blood frenzy. This ability functions like a barbarian’s rage (PH 25), except that the quaggoth suffers no ill effects after the rage ends.

When not raging, a quaggoth war leader has the following changed statistics:

```yaml
AC: 22, touch 10, flat-footed 22
hp: 118 (10 HD)
Saves: Fort +11, Will +8
Melee: +1 keen elf bane greataxe +19/+14/+9 (1d12+11/19–20/×3) or
Melee: +1 keen elf bane greataxe +21/+16/+11 (1d12+13/19–20/×3 plus 2d6) against elves and bite +13 (1d6+3)
Grp: +18
...
| ---- | ------------------------------------------------------------------------- | ---------------------- | ---------------------------------------- | ------------------------------------------------------------ |
| 1    | +1 Arrows, x10                                                            | x                      | on corpse                                |                                                              |
| 1    | Cloak of Elvenkind                                                        | x                      | on corpse                                |                                                              |
| 1    | 23 pp                                                                     |                        | on corpse                                |                                                              |
| 1    | 10 gp                                                                     |                        | on corpse                                |                                                              |
...
| 3    | potion of invisibility                                                    | x                      | among debris                             |                                                              |
| 3    | potion of neutralize poison                                               | x                      | among debris                             |                                                              |
| 3    | ring of water-walking                                                     | x                      | among debris                             |                                                              |
| 3    | bone plaque                                                               |                        | among debris                             |                                                              |
| 6    | wand of mage armor (27 charges)                                           | x                      | locked chest                             |                                                              |
| 6    | 50 pp                                                                     |                        | locked chest                             |                                                              |
| 6    | bloodstone gem, x2 (50 gp each)                                           |                        | locked chest                             |                                                              |
| 7    | ring of protection +2                                                     | x                      | in use by vampire spawn                  |                                                              |
...
| 13.5 | +3 ghost-touch undead-bane dagger \*                                      | x                      | search DC 20                             | "Pale Piercer" in draconic, crystal-hilted white iron dagger |
...
| 16e  | wand of magic missile (40 charges)                                        | x                      | in locked chest in secret room           |                                                              |
| 16f  | potion of cure serious wounds                                             | x                      | in sarcophagus f                         |                                                              |
...
| 21   | gloves of dexterity +2                                                    | x                      | within deep filth                        | no obvious stitch, skeletal hands still inside               |
| 21   | bracers of armor +2                                                       | x                      | within deep filth                        |                                                              |
...
| 24   | bag of tricks, rust-colored                                               | x                      | chest, half-buried                       |                                                              |
| 24   | potion of aid                                                             | x                      | chest, half-buried                       |                                                              |
| 31   | 110 pp                                                                    |                        | in sack                                  |                                                              |
...
| 45   | +2 shield of light fortification                                          | x                      | ashes, after 10 minute search            |                                                              |
| 45   | potion of eagle's splendor                                                | x                      | ashes, after 10 minute search            | was potion of charisma                                       |
| 52.1 | 3,500 gp                                                                  |                        | 10 minute search                         | 6d10x100 gp                                                  |
| 52.1 | jasper gems x8 (20 gp each)                                               |                        | 10 minute search                         | 1d8 20-gp gems                                               |
| 52.1 | wand of false life (50 charges)                                           | x                      | 10 minute search                         | 1d4 minor magic items (1)                                    |
| 52.2 | 3,900 gp                                                                  |                        | 10 minute search                         | 6d10x100 gp                                                  |
| 52.2 | azurite gems x3 (20 gp each)                                              |                        | 10 minute search                         | 1d8 20-gp gems                                               |
| 52.2 | arcane scroll, ray of enfeeblement                                        | x                      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 52.2 | divine scroll, detect animals or plants, longstrider, protection from law | x                      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 52.2 | +1 heavy mace                                                             | x                      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 52.3 | 3,800 gp                                                                  |                        | 10 minute search                         | 6d10x100 gp                                                  |
| 52.3 | malachite gems x3 (20 gp each)                                            |                        | 10 minute search                         | 1d8 20-gp gems                                               |
| 52.3 | arcane scroll, misdirection, whispering wind                              | x                      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 52.3 | dust of appearance                                                        | faint conjuration      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 52.3 | divine scroll, comprehend languages                                       | x                      | 10 minute search                         | 1d4 minor magic items (3)                                    |
| 53   | 4,500 gp                                                                  |                        | 10 minute search                         | 6d10x100 gp                                                  |
| 53   | bloodstone gems x5 (20 gp each)                                           |                        | 10 minute search                         | 1d8 20-gp gems                                               |
| 53   | arcane scroll, comprehend languages                                       | x                      | 10 minute search                         | 1d4 minor magic items (2)                                    |
| 53   | wand of cat's grace (50 charges)                                          | x                      | 10 minute search                         | 1d4 minor magic items (2)                                    |
...
| 55   | +2 keen kukri                                                             | x                      | on shelf                                 |                                                              |
| 57   | 2,000 sp                                                                  |                        | search of every grave, 30 minutes        |                                                              |
| 57   | silver pearls, x2 (100 gp each)                                           |                        | search of every grave, 30 minutes        |                                                              |
| 57   | scroll, mass suggestion                                                   | x                      | search of every grave, 30 minutes        |                                                              |
| 57   | wand of light                                                             | x                      | search of every grave, 30 minutes        | silvery birchbark stick                                      |
...
| 72   | 330 pp                                                                    |                        | in iron box buried in the coal pit       |                                                              |
| 72   | star rubies, x9 (1,000 gp each)                                           |                        | in iron box buried in the coal pit       |                                                              |
| 72   | heartstone                                                                | strong transmutation   | held by night hag A                      | aura is based on cloak of etherealness                       |
| 72   | ring of electricity resistance (minor)                                    |                        | held by night hag A                      |                                                              |
| 72   | heartstone                                                                | strong transmutation   | held by night hag B                      | aura is based on cloak of etherealness                       |
| 72   | ring of force shield                                                      |                        | held by night hag B                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 75   |                                                                           |                        | equipped by Redbone                      |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
...
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 76   |                                                                           |                        | equipped by Gulthias                     |                                                              |
| 77   | 442 pp                                                                    |                        | in grave soil inside heart               |                                                              |
| 77   | gold dragon comb with fire opal eye (2,500 gp)                            |                        | in grave soil inside heart               |                                                              |
| 77   | jeweled gold crown (5,000 gp)                                             |                        | in grave soil inside heart               |                                                              |
| 77   | banded mail of luck                                                       | x                      | in grave soil inside heart               |                                                              |
| 77   | lion's shield                                                             | x                      | in grave soil inside heart               |                                                              |
| 77   | Gulthias' backup spellbook                                                |                        | in grave soil inside heart               | makes sense, not published                                   |
| 77   | potion of lesser restoration                                              | x                      | on lab table                             |                                                              |
| 77   | potion of cause cerious wounds                                            | x                      | on lab table                             |                                                              |
| 77   | oil of slipperiness                                                       | x                      | on lab table                             |                                                              |
| 77   | books and scrolls of lore                                                 |                        | on bookshelves                           |                                                              |
| 77   | Gulthias' spellbook                                                       |                        | on bookshelves                           |                                                              |
