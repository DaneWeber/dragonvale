...
Many giants and fey know how to navigate conjunctions between the Material and Ethereal planes, and can use these conjunctions to travel between the planes, usually to transit to a demi-plane. The conjunctions are often conditional or temporary. A visitor may get lost or follow a fey to a "fairy land" where they cannot be found by normal means nor easily return. There are seas and islands accessible via the Ethereal plane that can be found with difficulty from the Material, although some elven ships are capable of navigating to or through the Ethereal on command.
