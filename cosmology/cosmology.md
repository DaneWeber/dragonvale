...
Chaos and Law are more primitive than Good and Evil.

Entropy is the inexorable progression of the universe from it's most distinct to it's most-thoroughly-mixed state. The greatest complexity arises in the middle. Both Chaos and Law seek to manage entropy and increase complexity, but in different ways.

|              | Low Entropy    | Medium Entropy | High Entropy |
| ------------ | -------------- | -------------- | ------------ |
| Complexity   | Simple         | Complex        | Simple       |
| Thing        | Crystal        | Life           | Gas          |
| Meal         | Ingredients    | Dish           | Digested     |
| Color mixing | Primary Colors | Full Spectrum  | Brown/Gray   |

Law is conservative, seeking to maximize complexity by preserving existing structures. Lawful systems create order, structure, and rules that maintain complexity. Lawful beings tend to be predictable, reliable, and stable.

Where effective, Law slows the progression of entropy, maintaining complexity over time. Where Law pulls too hard in the direction of lower entropy, it creates simple, rigid systems that are brittle, prone to catastrophic failure, of low complexity. At it's extreme, Law freezes things in place, preventing change over time which paradoxically reduces complexity.

Chaos is innovative, seeking to maximize complexity by creating new structures, regardless of duration. Chaotic systems introduce unpredictable change and novelty that increase complexity. Chaotic beings tend to be unpredictable, spontaneous, and dynamic, aiming to cause things to happen that have not happened before.

Where effective, Chaos increases complexity by introducing new structures. Where Chaos pulls too hard in the direction of higher entropy, it creates over-mixed systems that are simple, of low complexity. At it's extreme, Chaos dissolves all structure, preventing complexity from arising over time.

The fundamental disagreement between Chaos and Law is whether the duration of complexity is a factor in total complexity. If so, maintaining a complex state over time is valuable (Law). If not, abandoning a given complex state in favor of a new complex state is more valuable (Chaos).

|                   | Law                         | Chaos                       |
| ----------------- | --------------------------- | --------------------------- |
| Maximize          | Duration of complexity      | Variety of states over time |
| At the expense of | Change over time            | Acceleration of entropy     |
| Ideal outcome     | Stable growth               | Diverse innovation          |
| Failure mode      | Brittle, repetitive systems | Over-mixed systems          |
| Extreme outcome   | Stasis                      | Infinite mud                |
