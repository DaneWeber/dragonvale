...
0-LEVEL DRUID SPELLS (ORISONS) [6/day]
...
| ⁉️       | ~~Flaming Sphere~~          | for ???                                                                  |
| ❎       | ~~Summon Nature’s Ally II~~ | for Conjure Ice Beast II                                                 |

3RD-LEVEL DRUID SPELLS [4/day]
...
| Core     | Magic Fang, Greater:          | One natural weapon of subject creature gets +1/four levels on attack and damage rolls |
...
| 🪽 BoED   | Dancing Web:               | Energy strands deal 1d6 nonlethal damage per level plus entangles evil creatures for                                   |
| ❄️ Frost | Call Avalanche:            | Avalanche of ice and snow falls from the sky, burying subjects.                                                        |
| ❄️ Frost | Conjure Ice Beast V:       | Conjures ice creature to fight for you.                                                                                |
| ❄️ Frost | Hibernate:                 | Sends subject into state of hibernation for one week/level.                                                            |
| ❄️ Frost | Ice Shield:                | Subject gains damage reduction 15/—.                                                                                   |
| ❄️ Frost | Wall of Coldfire:          | Deals 2d4 of cold damage out to 10 ft. and 1d4 out to 20 ft. Passing through wall deals 2d6 frostburn damage +1/level. |
| 🔮 SC    | Bite of the Weretiger:     | +12 Str, +4 Dex, +6 Con, +5 Nat Armor                                                                                  |
| ❎       | ~~Atonement~~              | for Bite of the Weretiger                                                                                              |
| ❎       | ~~Control Winds~~          | for Call Avalanche                                                                                                     |
| ❎       | ~~Death Ward~~             | for Hibernate                                                                                                          |
| ❎       | ~~Summon Nature’s Ally V~~ | for Conjure Ice Beast V                                                                                                |
| ❎       | ~~Transmute Mud to Rock~~  | for Dancing Web                                                                                                        |
| ❎       | ~~Transmute Rock to Mud~~  | for Ice Shield                                                                                                         |
| ❎       | ~~Wall of Fire:~~          | for Wall of Coldfire                                                                                                   |
